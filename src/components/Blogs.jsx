...
const Blogs = () => {
  return (
    <div className='text-white lg:px-24 px-4'>
        {/* blog top  */}
        <div className="">
            <h2 className="text-4xl font-bold text-center leading-snug lg:w-4/6 mx-auto pb-20">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis nam dolore nesciunt recusandae, explicabo saepe.</h2>
        ...
        <div className="relative" id='blog'>
            <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-12">
                ...
                <div className="lg:w-1/3 space-y-5 z-30">
                    ...
                    <h2 className="text-5xl font-bold mb-5 leading-snug text-white">Explore recont works</h2>
